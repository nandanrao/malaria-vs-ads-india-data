...
\author{{ Nandan Rao}\thanks{Universitat Autonoma Barcelona}
\hspace{85pt} { Dante Donati}\thanks{Universitat Pompeu Fabra, BSE. Email: dante.donati@upf.edu}\vspace{5pt}
\\ { Victor Orozco-Olvera}\thanks{DIME, The World Bank} \hspace{25pt} {Ana Maria Muñoz-Boudet}\thanks{EMBED, The World Bank}\vspace{5pt}}

\title{Facebook Ads vs. Malaria:\\ A Cluster-Randomized Trial in India\thanks{We thank X, Y and Z, as well as seminar participants at W. We are grateful to A, B, C.\vspace{5pt}}}
